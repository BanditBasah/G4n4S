...
echo "\033[32;1mAuthor : Mr.R4HM4N"
echo "\033[37;1mFeat: Mr.H4MZ4H"
echo "\033[35;1mversion Tools: 9"
echo "\033[35;1mTeam : BTN CYBER CLAY"
echo "\033[33;1mKontak Me :  087764999371"
echo "\033[31;1mPlease For Subcribe Youtube:"
echo "\033[92mBanditBasah Official" 
...
echo "[===============================================]>"
echo $purple "2.> Spam Sms Telkamvret"
echo "[===============================================]>"
...
echo "[+]===============================================[+]"
echo "\033[32;1m"
read -p "root@T00Ls-B4ND1T~#" bro

if [ $bro = 1 ] || [ $bro = 1 ]
then
clear
figlet "Mr.R4HM4N" | lolcat
php tp.php
fi
...
then
clear
toilet -f mono12 -F gay "Mr.R4HM4N"
php phd.php
fi
...
then
clear
toilet -f slant -F gay "Mr.R4HM4N" 
...
then
clear
toilet -f standard -F gay "Mr.R4HM4N" 
...
mv torshammer $HOME
cd $HOME/torshammer
read -p "Masokan Target Nye woy==>:" target
...
clear
echo "\033[34;1m"
cowsay -f kiss.cow "MrR4HM4N" | lolcat
...
then
clear
cowsay -f sheep.cow "MrR4HM4N" | lolcat
figlet "Mr.R4HM4N" | lolcat
sleep 1
cd
cd module
...
echo "\033[32;1mauthor: "Mr.R4HM4N"
echo "\033[33;1mTeam: BTN CYBER CLAY"
echo "\033[34;1mIndonesia Security Lite"
echo "\033[32;1mRIAU Waithat Army"
...
clear
echo "\033[31;1m"
cowsay ghostbusters.cow "MrR4HM4N" 
figlet "Mr.R4HM4N" | lolcat
apt update && apt upgrade
apt install python2
apt install python
...
then
clear
cowsay -f kiss.cow "MrB4ND1T" | lolcat
figlet "Mr.B4ND1T" | lolcat
sleep 1
apt update && apt upgrade
apt install python2
apt install git
...
then
clear
cowsay -f kiss.cow "Mr.B4ND1T" | lolcat
figlet "Mr.B4ND1T" | lolcat
sleep 1
apt update && apt upgrade
apt install git
...
then
clear
toilet -f standard -F gay "Mr.B4ND1T"
pkg install git
pkg install python2
...
then
clear
toilet -f standard -F gay "Mr.4NC4"
...
then
clear
toilet -f big -F gay "Mr.B4ND1T " | lolcat
sleep 1
